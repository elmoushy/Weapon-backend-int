"""
Security utilities for file uploads and content sanitization.
Provides HTML sanitization, file validation, and filename sanitization
to prevent XSS attacks, path traversal, and malicious file uploads.

Originally from internal_chat, moved here for shared use across apps.
"""
import bleach
import logging
import re
